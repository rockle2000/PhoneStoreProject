                ...
                <form method="POST" action="{{route('user.updatepass',['id' => $customer->id])}}">
                    ...
                    <div class="row mt-2">
                        <div class="col-md-12 d-flex justify-content-between align-items-center">
                            ...
                            <input type="password" class="form-control form-control-user @error('oldpass') is-invalid @enderror" id="examplePassword" placeholder="Nhập mật khẩu cũ" name="oldpass" value="{{ old('oldpass')}}">
                        </div>
                        @error('oldpass')
                    ...
                    <div class="mt-5 text-right">
                        <button class="btn btn-success profile-button" type="submit">Thay đổi</button>
                    </div>
                </form>
            </div>
        </div>
